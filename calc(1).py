...
@details    : Calculator with standard and scientific mode
...
btnacosh = Button(calc, text="acosh", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg='powder blue',command= added_value.a_cosh).grid(row=4,
                                                                                                                  column=6,
                                                                                                                  pady=1)

btnasinh = Button(calc, text="asinh", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg='powder blue', command=added_value.a_sinh).grid(row=4,
                                                                                                                  column=7,
                                                                                                                  pady=1)

btnlog10 = Button(calc, text="log10", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg='powder blue', command=added_value.log10).grid(row=5,
                                                                                                                  column=4,
                                                                                                                  pady=1)

btnlog1p = Button(calc, text="log1p", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg='powder blue',command=added_value.log1p).grid(row=5,
                                                                                                                  column=5,
                                                                                                                  pady=1)

btnexpm1 = Button(calc, text="expm1", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg='powder blue',command=added_value.expm1).grid(row=5,
                                                                                                                  column=6,
                                                                                                                  pady=1)

btn1gamma = Button(calc, text="1gamma", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg='powder blue', command =added_value.lgamma).grid(
